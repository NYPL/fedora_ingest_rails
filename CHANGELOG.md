...
## Unreleased
- Patch critical security vulnerability: https://github.com/NYPL/fedora_ingest_rails/security/dependabot/139 (DR-4206)
...
- Update OCR S3 path (DR-4134)

## [3.4] - 2026-05-29

### Changed
- Add support for AllMaps indexing. (DR-4105)
