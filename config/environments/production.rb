...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "fedora_ingest_rails_#{Rails.env}"
  ...
  config.iiif_host = ENV['IIIF_HOST'] || 'https://iiif-qa.nypl.org' # qa environment override from task definition
end
